    ...
    >
      ...
      <div className="flex-1 flex flex-col min-h-0 relative z-10">
        <div className={`flex gap-3 items-center shrink-0 ${thinnerCard ? 'mb-1.5' : 'mb-3'}`}>
          ...
          <span className="text-[10px] tracking-wider font-extrabold px-2.5 py-0.5 rounded bg-purple-500/10 text-purple-500 dark:text-purple-400 border border-purple-500/20 whitespace-nowrap shrink-0">
            CERTIFICATION
          </span>
